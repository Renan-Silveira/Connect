def extract():
    ...
    URL = os.getenv("URL") # Obtém a URL do arquivo
    DIR_DATA = os.getenv("DIR_DATA") # Obtém o diretório onde o arquivo será salvo
    DIR_DATARAW = os.getenv("DIR_DATARAW") # Obtém o diretório onde os dados extraídos serão salvos
    NOME_FILE = os.getenv("NOME_FILE") # Obtém o nome do arquivo a ser salvo
    ...
    def download_file(URL, path): # Função para baixar um arquivo da URL
